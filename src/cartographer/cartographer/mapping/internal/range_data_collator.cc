...
sensor::TimedPointCloudOriginData RangeDataCollator::AddRangeData(
    ...
    timed_point_cloud_data.intensities.resize(timed_point_cloud_data.ranges.size(),
                                              kDefaultIntensityValue);
    ...
    for (auto it = id_to_pending_data_.begin(); it != id_to_pending_data_.end();) {
        ...
        // 用了一部分的点
            ...
            data = sensor::TimedPointCloudData{
                data.time, data.origin, sensor::TimedPointCloud(overlap_end, ranges.end()),
