...
void CeresScanMatcher2D::Match(const Eigen::Vector2d& target_translation,
    ...
    switch (grid.GetGridType()) {
        case GridType::PROBABILITY_GRID:
            ...
            break;
        case GridType::TSDF:
            problem.AddResidualBlock(CreateTSDFMatchCostFunction2D(
                                         options_.occupied_space_weight() /
                                             std::sqrt(static_cast<double>(point_cloud.size())),
    ...
    problem.AddResidualBlock(TranslationDeltaCostFunctor2D::CreateAutoDiffCostFunction(
    ...
    *pose_estimate = transform::Rigid2d({ceres_pose_estimate[0], ceres_pose_estimate[1]},
