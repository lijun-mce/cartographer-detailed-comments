...
public:
     ...
     * 此坐标系与任何其他坐标系之间的转换都会跳变. 它的z轴指向上方, 即重力加速度矢量指向-z方向,
     * 即由加速度计测得的重力分量沿+z方向.
     */
    ...
    int AddTrajectory(const std::set<::cartographer::mapping::TrajectoryBuilderInterface::SensorId>&
                          expected_sensor_ids,
